...
def about():
    ...
    img31.pack()
    valid_var = "I'M THE STUDENT OF JC BOSE UNIVERSITY OF SCIENCE AND TECHNOLOGY, FARIDABAD"
    valid_var1 = "I'm developing this project to help persons to check \nwhether they have BREAST CANCER or not.\nUser provide some values to the model and \nmodel predict the diagnosis.\nThis model have 95% + accuracy."
    valid_var2 = " Gaurav Rana "
